...
MBP.splash = function () {
  ...
  document.write('<link rel="apple-touch-startup-image" href="images/img/' + filename + 'splash.png" />');
};
...
MBP.autogrow = function (element, lh) {
  ...
  var setLineHeight = (lh) ? lh : 12, textLineHeight = element.currentStyle ? element.currentStyle.lineHeight : getComputedStyle(element, null).lineHeight;
